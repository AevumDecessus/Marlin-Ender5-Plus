 ...
 */
// AevumEdit export full config json on build
 ...
 */
// AevumEdit automatically turn off nozzle heater if idle for over 5 minutes
 ...
 */
// AevumEdit Set the Extruder fan pin
...
// @section bltouch
  ...
  // AevumEdit add a delay for the BLTOUCH to change states
 ...
 */
// AevumEdit use both steppers to align using the bed probe
#define Z_STEPPER_AUTO_ALIGN
   ...
   */
    ...
    // AevumEdit define the Z stepper orientation
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  // AevumEdit add a z probe offset calibration to the lcd menu
  ...
  // AevumEdit enable the LCD info menu
  ...
  // AevumEdit autoscroll long status messages
  ...
  // AevumEdit show the filament used during printing
 ...
 */
// AevumEdit Enable Z-Offset babystepping
#define BABYSTEPPING
  ...
  // AevumEdit display total babysteps since G28
  #define BABYSTEP_DISPLAY_TOTAL          // Display total babysteps since last G28

  // AevumEdit combine our M581 Z with babystepping for first layer height tweaking
 ...
 */
// AevumEdit Enable Linear Advance
#define LIN_ADVANCE
 ...
 */
// AevumEdit parse emergency commands before all others in queue
...
// AevumEdit enable Serial float precision for talking to the screen
 ...
 */
// AevumEdit enable Advanced Pause for filament runout/change
#define ADVANCED_PAUSE_FEATURE
  ...
  // AeuvmEdit direct drive needs less unloading
  ...
  // AevumEdit Park the nozzle during pauses
  #define PARK_HEAD_ON_PAUSE                    // Park the nozzle during pause and filament change.
  //#define HOME_BEFORE_FILAMENT_CHANGE           // If needed, home before parking for filament change

  // AevumEdit enable the filament load/unload gcodes
 ...
 */
// AevumEdit turn on auto report of position
...
#define EXTENDED_CAPABILITIES_REPORT
  ...
  // AevumEdit turn on the M115 geometry report
...
// AevumEdit enable M114 detail reporting
#define M114_DETAIL         // Use 'M114` for details to check planner calculations
//#define M114_REALTIME       // Real current position based on forward kinematics
//#define M114_LEGACY         // M114 used to synchronize on every call. Enable if needed.

// AevumEdit report fan speed changes after M106 commands
 ...
 */
// AevumEdit enable GCode Macros for tool change system
#define GCODE_MACROS
 ...
 */
// AevumEdit enable Host Action Commands
#define HOST_ACTION_COMMANDS
#if ENABLED(HOST_ACTION_COMMANDS)
  //#define HOST_PAUSE_M76                // Tell the host to pause in response to M76
  // AevumEdit also enable HOST_PROMPT_SUPPORT
