...
// AevumEdit give it a name, James.
#define CUSTOM_MACHINE_NAME "Ender 5 Plus Maximum"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
// AevumEdit give it a UUID
#define MACHINE_UUID "c120f9c6-6da6-11ed-a1eb-0242ac120002"
 ...
 */
// AevumEdit set the driver type for all 5 stepper motors
...
// AevumEdit use a 100kΩ resistor for the bed sensor
 ...
 * @section bed temp
 */
// AevumEdit enable PID tuning for the heated bed
#define PIDTEMPBED
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // AevumEdit 120v 1000W silicone heater into cast aluminum bed
  #define DEFAULT_bedKp 55.2603
  #define DEFAULT_bedKi 2.8781
  #define DEFAULT_bedKd 707.3317
...
// AevumEdit Use XMAX and YMAX to reverse the direction of the plane on the 
// ender 5 plus to move 0,0 to the lower left corner to match slicers/tft35
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
// AevumEdit increase max accel with linear rails
 ...
 */
// AevumEdit increase default acceleration
 ...
 */
// AevumEdit probe twice for higher accuracy
...
// AevumEdit use the Z-Probe repeatability test
...
// :[-1,1]
// AevumEdit reverse direction of X and Y home to match slicers/tft35
#define X_HOME_DIR 1
#define Y_HOME_DIR 1
#define Z_HOME_DIR -1
//#define I_HOME_DIR -1
...
// AevumEdit set the correct bed size for ender 5 plus
...
// AevumEdit set the correct Z-height
 ...
 */
// AevumEdit enable the filament runout sensor
 ...
 */
// AevumEdit restore bed leveling after G28
...
//#define DEBUG_LEVELING_FEATURE
   ...
   */
  // AevumEdit enable G26 mesh validation pattern tool
  ...
  // AevumEdit enable 5x5 grid for bilinear bed leveling
  ...
  // AevumEdit graphics mesh overlays ftw
  ...
  // AevumEdit use Hilbert curve, less travel during grid measurement
...
// AevumEdit enable LCD bed tramming memu for manual leveling measurements
#define LCD_BED_TRAMMING

#if ENABLED(LCD_BED_TRAMMING)
  // AevumEdit move the corner probes a little more into the bed
  #define BED_TRAMMING_INSET_LFRB { 50, 50, 50, 50 } // (mm) Left, Front, Right, Back insets
  #define BED_TRAMMING_HEIGHT      0.0        // (mm) Z height of nozzle at leveling points
  #define BED_TRAMMING_Z_HOP       4.0        // (mm) Z height of nozzle between leveling points
  // AevumEdit move back to center after bed tramming
 ...
 */
// AevumEdit make sure the probe doesn't hit the sides of the bed
 ...
 */
// AevumEdit enable EEPROM settings for UBL
...
// AevumEdit define a preheat for PETG
 ...
 */
// AevumEdit Set the nozzle park feature on pause
...
//
// AevumEdit enable the Home X, Y, Z individual menus
...
//
// AevumEdit enables for TFT35 screen
